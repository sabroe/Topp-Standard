...
package gradle.kotlin.dsl.plugins._e565552433194872cfc84fb6a50458fd
...
/**
 * The `com.dorongold` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComDorongoldPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.dorongold`.
 */
internal
val `ComPluginGroup`.`dorongold`: `ComDorongoldPluginGroup`
    get() = `ComDorongoldPluginGroup`(plugins)


/**
 * The `com.dorongold.task-tree` plugin implemented by [com.dorongold.gradle.tasktree.TaskTreePlugin].
 */
internal
val `ComDorongoldPluginGroup`.`task-tree`: PluginDependencySpec
    get() = plugins.id("com.dorongold.task-tree")
