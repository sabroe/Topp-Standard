...
/**
 * Item attached to a classloader.
 *
 * @author Morten Sabroe Mortensen
 * @since 2025-06-26
 */
@AllArgsConstructor(staticName="of")
final class ClassLoaderItem implements Item {
    /**
     * Classloader.
     */
    ...
    public URI getURI() {
        try {
            URL url=classLoader.getResource(location.getName());
    ...
    @Override
    public URL getURL() {
        return classLoader.getResource(location.getName());
    }
