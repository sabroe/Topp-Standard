...
public final class ClassLoaderResource implements Resource {  //TO-DO: Name? "LookupBasedResource"?
    ...
    public URI getURI() {
        try {
            URL url=lookup.getResource(name);
    ...
    @Override
    public InputSource read() {
        return InputSources.createInputSource(lookup,name);
    }
}
