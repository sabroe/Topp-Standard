...
public class Conditional2<C,X,R> {  //TO-DO: Consider placement and typing; this is not really specific for SLF4J!
    /**
...
*/
    ...
    public static class Builder<C,X,R> {
        ...
        public Conditional2<C,X,R> build() {
            ...
            return Conditional2.of(id,context,transformation);
        }
