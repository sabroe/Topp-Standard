...
public interface BiFunctionWithException<T, U, R, E extends Exception> {  //TO-DO: Consider the presence of this in overlap with other libraries of mine! MSM, 2024-09-11.
    /**
